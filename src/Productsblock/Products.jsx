                    ...
                    <div className="inner_block">
                        ...
                        />
                                       ...
                                       <div className="text">
                                        ...
                                        <p className="contentss">{props.attri.benefits}</p>
                                        </div>
                              </div>    
                         </div> <br/>
                        <div className="name_Class">{props.attri.productname}</div><br/>
                        <div className="name_Class">Price - {props.attri.price} per {props.attri.unit}</div><br/>

                        {/* <Link target="_self" to="/Order"> <button  className="butt">Add To Cart</button></Link><br/> */}
                        <Link target="_self" to='/Order'><button className="butt" onClick={() => saver(props.attri.productname)}>Buy Now</button><br/></Link><br/>
